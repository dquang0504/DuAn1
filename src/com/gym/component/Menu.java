...
import com.gym.model.Model_Menu;
...
public class Menu extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        listMenu1 = new com.gym.swing.ListMenu<>();

        panelMoving.setOpaque(false);

        jLabel1.setFont(new java.awt.Font("sansserif", 1, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/gym/icon/logo48.png"))); // NOI18N
        jLabel1.setText("Gym Software");
    ...
    protected void paintChildren(Graphics grphcs) {
        ...
        GradientPaint g = new GradientPaint(0, 0, Color.decode("#1f4037"), 0, getHeight(), Color.decode("#99f2c8"));
        g2.setPaint(g);
    ...
    private com.gym.swing.ListMenu<String> listMenu1;
