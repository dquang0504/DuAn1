...
public class QuanLyNhanVien extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblNhanVien.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã NV", "Họ Tên", "Ngày sinh", "Điện thoại", "Email", "Vai Trò", "Giới tính", "Trạng thái", "Hình"
            }
        ) {
...
//        nv.setMatKhau(new String(txtPass.getPassword()));
        ...
        nv.setTrangThai(rdoMo.isSelected());
    ...
    void setForm(NhanVien nv) {
        ...
        rdoMo.setSelected(nv.isTrangThai());
        rdoKhoa.setSelected(!nv.isTrangThai());
